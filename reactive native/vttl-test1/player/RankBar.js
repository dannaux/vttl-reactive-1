...
export default class RankBar extends Component {
  ...
  constructor(props) {
    super(props);
    this.woncolor = '#66ab8c';
    this.losscolor = '#fa7c92';
  }
     ...
     if (this.props.ranking != "") {
       return (
           <View key={this.props.ranking} style={{flexDirection: 'row', alignItems: 'stretch', marginLeft: 15, marginTop: 8}}>
            ...
            <View key={this.props.ranking+"-winbar"} style={{height: 20, width: 250*this.winperc()*this.relativematches(), backgroundColor: this.woncolor}} />
            <View key={this.props.ranking+"-lossbar"} style={{height: 20, width: 250*this.lossperc()*this.relativematches(), backgroundColor: this.losscolor}} />
